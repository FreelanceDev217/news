...
- [ ] Add an email address to the `ADMINS` settings variable in `news/news/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `news/news/settings/production.py`
...
- Create a copy of ``news/settings/local.py.example``:  
  `cp news/settings/local.py.example news/settings/local.py`
